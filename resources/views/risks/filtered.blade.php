            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-lg font-medium text-gray-900">{{ $filterTitle }}</h3>
                                ...
                                @foreach ($risks as $risk)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            ...
                                            @if (Auth::id() === $risk->user_id  || ($risk->collaborators && $risk->collaborators->where('user_id', Auth::id())->where('permission', 'edit')->count() > 0))
                    ...
                    @else
                        <p>No risks found matching this filter. <a href="{{ route('risks.create') }}" class="text-blue-500 hover:text-blue-700">Create a new risk</a>.</p>
                    @endif
                </div>
            </div>
        </div>
