            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <!-- Total Risks -->
                        <a href="{{ route('dashboard.filter.all') }}" class="block">
                        ...
                        <!-- High Risks -->
                        <a href="{{ route('dashboard.filter.level', 'high') }}" class="block">
                        ...
                        <!-- Open Risks -->
                        <a href="{{ route('dashboard.filter.status', 'open') }}" class="block">
                            <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 hover:bg-yellow-100 transition-colors">
                                <div class="flex items-center">
                        ...
                        <!-- Your Risks -->
                        <a href="{{ route('dashboard.filter.user') }}" class="block">
                    ...
                    @if (Auth::user()->role === 'admin')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                            ...
                            <a href="{{ route('admin.users') }}" class="block">
                                <div class="bg-purple-50 border border-purple-200 rounded-lg p-4 hover:bg-purple-100 transition-colors">
                                    <div class="flex items-center">
                            ...
                            <a href="{{ route('categories.index') }}" class="block">
                                <div class="bg-indigo-50 border border-indigo-200 rounded-lg p-4 hover:bg-indigo-100 transition-colors">
                                    <div class="flex items-center">
